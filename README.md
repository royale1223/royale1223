...
AI/LLM      →  Claude API, OpenAI API, Gemini, prompt engineering
Domain      →  EMR/EHR, clinical workflows, health data, patient decision support
```
...
Remote contracts in **health tech**, **clinical software**, **EMR/EHR systems**, or **backend engineering** (US / UK / EU).

📧 kbinoybaby@gmail.com

---

*"The best healthcare software is built by people who've used a stethoscope."*
